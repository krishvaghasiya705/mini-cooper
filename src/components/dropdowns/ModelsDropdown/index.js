            ...
            <div className="ModelsDropdown-content-rl">
              <div className="model-side-one">
                ...
                <div className="ModelDropdown-cars-content-main">
                  <div className={`ModelDropdown-car-box box1 ${openBox === 1 || lastOpenBox === 1 ? "ModelDropdown-car-box-active" : ""}`} onMouseEnter={() => handleMouseEnter(1)}>
                    <div className="ModelDropdwon-car">
                      <img src={Dropdowncar1} alt="Dropdowncar1" />
                    </div>
                    <p>Countryman S ALL4</p>
                  </div>
                  <div className={`ModelDropdown-car-box box2 ${openBox === 2 || lastOpenBox === 2 ? "ModelDropdown-car-box-active" : ""}`} onMouseEnter={() => handleMouseEnter(2)}>
                    <div className="ModelDropdwon-car">
                      <img src={Dropdowncar2} alt="Dropdowncar2" />
                    </div>
                    <p>JCW Countryman ALL4</p>
                  </div>
                  <div className={`ModelDropdown-car-box box3 ${openBox === 3 || lastOpenBox === 3 ? "ModelDropdown-car-box-active" : ""}`} onMouseEnter={() => handleMouseEnter(3)}>
                    <div className="ModelDropdwon-car">
                      <img src={Dropdowncar3} alt="Dropdowncar3" />
                    </div>
                    <p>Cooper 2 Door</p>
                  </div>
                  <div className={`ModelDropdown-car-box box4 ${openBox === 4 || lastOpenBox === 4 ? "ModelDropdown-car-box-active" : ""}`} onMouseEnter={() => handleMouseEnter(4)}>
                    <div className="ModelDropdwon-car">
                      <img src={Dropdowncar4} alt="Dropdowncar4" />
                    </div>
                    <p>Cooper S 4 Door</p>
                  </div>
                  <div className={`ModelDropdown-car-box box5 ${openBox === 5 || lastOpenBox === 5 ? "ModelDropdown-car-box-active" : ""}`} onMouseEnter={() => handleMouseEnter(5)}>
                    <div className="ModelDropdwon-car">
              ...
              <div className="model-side-two">
                ...
                <div className="Explore-model-main">
                  ...
                  <div className="Explore-model-inner-main">
                    <div className={`ModelDropdown-car-box box6 ${openBox === 6 || lastOpenBox === 6 ? "ModelDropdown-car-box-active" : ""}`} onMouseEnter={() => handleMouseEnter(6)}>
                      <div className="ModelDropdwon-car">
                        <img src={Explorefirstimage} alt="Explorefirstimage" />
                      </div>
                      <p>2025 New MINI Family</p>
                    </div>
                    <div className={`ModelDropdown-car-box box7 ${openBox === 7 || lastOpenBox === 7 ? "ModelDropdown-car-box-active" : ""}`} onMouseEnter={() => handleMouseEnter(7)}>
                      <div className="ModelDropdwon-car">
                        <img src={Exploresecondimage} alt="Exploresecondimage" />
                      </div>
                      <p>John Cooper Works</p>
                    </div>
                    <div className={`ModelDropdown-car-box box8 ${openBox === 8 || lastOpenBox === 8 ? "ModelDropdown-car-box-active" : ""}`} onMouseEnter={() => handleMouseEnter(8)}>
                      <div className="ModelDropdwon-car">
